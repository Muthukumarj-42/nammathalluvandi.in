  ...
  return (
    <main className="bg-[#fffdf7] min-h-screen text-[#1a1208] pb-16 pt-6 md:pt-24">
      <div className="max-w-lg mx-auto px-4">
        ...
        {/* Cart Summary Card */}
        <div className="mt-6 overflow-hidden rounded-2xl border border-[#f97316]/20 bg-white p-4 shadow-sm flex flex-col gap-4">
            ...
            <input
              ...
              className={`w-full h-12 border focus:ring-2 rounded-xl px-4 bg-white text-base outline-none transition ${
                phoneError
                  ...
                  : "border-[#e5e0d8] focus:border-[#f97316] focus:ring-focus:ring-[#f97316]/40"
              }`}
            />
            {phoneError && (
